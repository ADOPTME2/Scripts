...
$From = "frasier.foston@gmail.com" # Put the SENDER HERE
$To = "frasier.foston@gmail.com" # Put the RECEIVER HERE
...
$Password = "riel kehk zaye xflv" | ConvertTo-SecureString -AsPlainText -Force
